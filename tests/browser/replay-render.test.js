...
test("the report card this page renders names no finding either", () => {
  ...
  assert.deepEqual(
    ...
    new Set([
      ...
      "Legacy/unversioned", "NO", "No", "Practice", "REACTO/STAR", "Reached",
      "Scenario", "Spaced", "Strengths", "Success:", "Test", "This", "What",
      "Your", "\u00b7", "above.", "algorithm", "an", "and", "are", "attempt",
      "back", "back,", "back:", "be", "behavioral", "bring", "bundle", "by",
      "calibrated", "candidate_speech", "cannot", "captured)", "chain",
      "coaching", "code", "coding", "communication", "complete", "complexity:",
      "confidence", "contract", "contract:", "dropped", "during", "empty)",
      "evaluation", "event", "every", "evidence", "evidence.", "final", "for",
      "formative", "happened", "held", "high", "hint", "hints", "hiring",
      "how", "impact", "interview", "interviewer", "is", "it", "kept,",
      "ladder", "listed", "lobby", "malformed", "min", "more", "much", "next",
      "not", "observed", "of", "offers", "only", "or", "packet", "performance",
