...
test("the report card this page renders names no finding either", () => {
  ...
  assert.deepEqual(
    ...
    new Set([
      ...
      "Chain", "CodeTrial.", "Coding", "Committee", "Common", "Communication",
      "Contract", "Done", "Download", "Evidence", "FACE_MISSING", "Follow-ups",
      "Framework", "Given:", "HIRE", "Held", "Hint", "INCOMPLETE", "Improve",
      "Integrity", "Interview", "Interviewer", "Legacy/unversioned", "NO",
      "No", "Practice", "REACTO/STAR", "Scenario", "Spaced", "Strengths",
      "Success:", "Test", "This", "What", "Your", "\u00b7", "above.",
      "algorithm", "an", "and", "are", "attempt", "back", "back,", "back:",
      "be", "behavioral", "bring", "bundle", "by", "calibrated",
      "candidate_speech", "cannot", "captured)", "chain", "coaching", "code",
      "coding", "communication", "complete", "complexity:", "confidence",
      "contract", "contract:", "dropped", "during", "empty)", "evaluation",
      "event", "every", "evidence", "evidence.", "final", "for", "formative",
      "happened", "held", "high", "hints", "hiring", "how", "impact",
      "interview", "interviewer", "is", "it", "kept,", "ladder", "listed",
      "lobby", "malformed", "min", "more", "much", "next", "not", "observed",
      "of", "offers", "only", "or", "packet", "performance", "phase",
      "pitfalls:", "predates", "problem", "recall.", "report", "reporting:",
      "review", "rounds", "rubric", "schema", "scored", "scores", "session",
      "signals,", "so", "source", "space", "space.", "started", "summary",
      "tests", "the", "this", "through", "to", "unknown.", "unsupported",
      "used", "uses", "v1", "verified", "version", "warning", "was", "were",
      "will", "your",
    ]),
